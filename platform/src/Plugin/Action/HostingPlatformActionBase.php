...
/**
 * Base action for platform task operations.
 */
abstract class HostingPlatformActionBase extends ActionBase {
  ...
  public function execute($entity = NULL) {
    if (!$entity instanceof EntityInterface || $entity->getEntityTypeId() !== 'hosting_platform') {
      return;
    }
  ...
  public function access($object, AccountInterface $account = NULL, $return_as_object = FALSE) {
    ...
    if (!$object instanceof EntityInterface || $object->getEntityTypeId() !== 'hosting_platform') {
