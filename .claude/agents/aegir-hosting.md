---
name: aegir-hosting
description: Specialist agent for the aegir-hosting frontend Drupal modules. Use when working on entities, forms, services, task queue, ContextRegistry, BackendInvoker, or any PHP code in this repository. Knows all 13 entities, 26 services, 25 forms, and the plugin system.
---
...
**Path**: `web/modules/contrib/aegir-hosting/` (this repository)
