...
description: Cross-component orchestrator for the Aegir Hostmaster project. Use when tasks span multiple repositories (hosting + provision + eldir), for architecture questions affecting multiple components, or to understand the full data flow from frontend form to infrastructure execution.
---
...
All repos use `dev/d11-new` as the active Git branch.
